package conf.sunsmasher.com.conferenceapp;
...
public class ConferenceAgenda extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_conference_agenda, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            // Return a MyAgendaFragment (defined as a static inner class below).
            switch (position) {
                case 0:
                    return ConferenceFragment.newInstance(position);
                case 1:
                    return MyAgendaFragment.newInstance(position);
                case 2:
    ...
    public static class ConferenceFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_conference_agenda, container, false);
            return rootView;
        }
    }
     ...
     * A placeholder fragment containing a simple view.
     */
    public static class MyAgendaFragment extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
         ...
         * number.
         */
        public static MyAgendaFragment newInstance(int sectionNumber) {
    ...
    public static class LocationFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.fragment_location_agenda, container, false);
            return rootView;
        }
    }
